...
export class MemberService implements OnInit {
  ...
  getMembers(userParams:UserParams) {
    ...
    return this.paginatedResult<Member[]>(this.baseUrl + 'users', params)
      .pipe(map(response => {
  ...
  private paginatedResult<T>(url, params) {
  ...
  getLikes(predicate:string, pageNumber:number, pageSize:number)
  {
    ...
    return this.paginatedResult<Partial<Member[]>>(this.baseUrl+'likes/', params, );
  }
}
